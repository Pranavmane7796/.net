...
public static class DBmanager
{
    ...
    public static string coString = @"server=Localhost;port=3306;user=root; password=root;database=pranav";
    ...
    public static void Edit(User u)
    {
        MySqlConnection con = new MySqlConnection();
        con.ConnectionString = coString;
        string query = "update registration set id=@id,firstname=@fname,lastname=@lname,email=@email where id=@id";
        MySqlCommand cmd = new MySqlCommand(query, con);
